...
class RedisConnectionError(VisionDetectionError):
    ...
    """
    def __init__(self, operation: str, host: str, port: int, 
...
class ImageProcessingError(VisionDetectionError):
    ...
    """
    def __init__(self, operation: str, image_info: Optional[dict] = None, 
                 original_error: Optional[Exception] = None):
        self.operation = operation
...
class DependencyError(VisionDetectionError):
    ...
    """
    def __init__(self, dependency: str, operation: str, 
...
class AnnotationError(VisionDetectionError):
    ...
    """
    def __init__(self, annotation_type: str, detection_count: int,
                 original_error: Optional[Exception] = None):
...
def handle_detection_error(error: Exception, image_shape: tuple, 
                           model_name: str) -> DetectionError:
    """
...
def handle_redis_error(operation: str, host: str, port: int, 
                       error: Exception) -> RedisConnectionError:
    """
