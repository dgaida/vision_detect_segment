...
class VisionConfig:
    ...
    def _get_default_labels() -> List[str]:
        ...
        geometric_shapes = [
            "blue circle", "blue square", "blue box", "blue cube",
            "red circle", "red square", "red box", "red cube", 
            "green circle", "green coin", "green cylinder", "green square",
            "orange cube", "purple cube", "yellow cube", "green cube"
        ]
        
        office_items = [
            "black pen", "black ballpoint pen", "pen", "pencil",
            "book", "computer mouse", "usb stick", "remote control",
            "battery", "batteries", "screwdriver"
        ]
        
        food_items = [
            "chocolate bar", "bounty", "snickers", "mars", "milky way", 
            "twix", "snickers bar", "sweets", "mandarin", "apple", "coke can"
        ]
        
        lighting_items = [
            "lighter", "cigarette lighter", "philips batteries"
        ]
